  ...
  <div class="system-setting">
    <div class="system-setting-page">
      ...
      <div class="setting-content" v-if="activeTag !== null">
        <loginSetting v-if="activeTag === '岗位人员登录设置' && !showEdit" @updateShowEdit="updateShowEdit"/>
        <loginSettingEdit v-if="activeTag === '岗位人员登录设置' && showEdit" @updateShowEdit="updateShowEdit"/>
