...
const staffInfoSee = defineAsyncComponent(() =>
  import('./seeDetail/teacherSee.vue')
);
const staffInfoSeeDetail = defineAsyncComponent(() =>
  import('./seeDetail/teacherSeeDetail.vue')
);
const staffDimission = defineAsyncComponent(() =>
  import('./teacherDimission.vue')
);
const staffDimissionDelete = defineAsyncComponent(() =>
  import('./teacherDimissionDelete.vue')
);
const teacherRoyalty = defineAsyncComponent(() =>
  import('./teacherRoyalty.vue')
);
