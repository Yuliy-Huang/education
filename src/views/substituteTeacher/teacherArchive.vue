<template>
  <div class="staff-edit">
    ...
    <div class="row2">
      ...
      <div class="col2">
        <el-form :model="form" label-width="auto" class="info-form">
          <el-form-item label="专业：" class="div-required">
            <el-input v-model="form.name" />
          </el-form-item>
          <el-form-item label="教龄：" class="div-required">
            <el-input v-model="form.name" />
          </el-form-item>
          <el-form-item label="电话：" class="div-required">
            <el-input v-model="form.sex" />
          </el-form-item>
          <el-form-item label="院校：" class="div-no-required">
            <el-input v-model="form.birth" />
          </el-form-item>
          <el-form-item label="住址：" class="div-no-required">
            <el-input v-model="form.place" />
          </el-form-item>
        </el-form>
      </div>
      <div class="col3">
        <div class="col3-div">
          <el-form :model="form" label-width="auto" class="info-form">
            ...
            <el-form-item label="上课分成：" class="div-required">
              <el-button plain @click="changeTab">点击进入</el-button>
            </el-form-item>
            <el-form-item label="入职时间：" class="div-required">
              <el-input v-model="form.name" />
            </el-form-item>
          </el-form>
          <el-input
