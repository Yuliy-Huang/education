<template>
  <div class="staff-dimission">
    ...
    <div class="row2">
      ...
      <div class="col2">
        <el-form :model="form2" label-width="auto" class="info-form">
      ...
      <div class="col2">
        <el-form :model="form3" label-width="auto" class="info-form">
...
<style lang="less">
@import '@/assets/css/substituteTeacher/teacherDimissionCss.less';
</style>
